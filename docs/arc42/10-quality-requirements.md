...
| Q5 | **Datenkonsistenz** | Eine Rollenzuweisung im IAM muss zuverlässig im Trips-SCS ankommen | RabbitMQ garantiert At-Least-Once-Delivery, Consumer sind idempotent |
